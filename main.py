...
class Chatbot:
    ...
    def greet(self):
        ...
        print(
            f"Hi {self.name}, I am Angel Joshi's Chatbot. I can help you with your doubts related to Hunar Intern and career development.\n"
    ...
    def match_reply(self, reply):
        ...
        for intent, regex_pattern in self.alienbabble.items():
            if re.match(regex_pattern, reply):
                ...
                if intent == 'describe_hunar_intern':
                    return self.describe_hunar_intern()
                elif intent == 'about_courses':
                    return self.about_courses()
                elif intent == 'about_internships':
                    return self.about_internships()
                elif intent == 'skill_improvement_tips':
                    return self.skill_improvement_tips()
                elif intent == 'course_recommendation':
                    return self.course_recommendation()
                elif intent == 'experience_with_hunar':
                    return self.experience_with_hunar()
                elif intent == 'internship_interest':
                    return self.internship_interest()
                elif intent == 'how_are_you':
                    return self.how_are_you()
                elif intent == 'what_are_you':
                    return self.what_are_you()
                elif intent == 'who_made_you':
                    return self.who_made_you()
                elif intent == 'who_is_creator':
                    return self.who_is_creator()
    ...
    def skill_improvement_tips(self):
        ...
        responses = (
            ...
            "Finally, consider reading books or taking courses on topics that interest you, such as algorithms or design patterns.\n"
            "Also, to enhance your resume, highlight your skills, relevant coursework, and any projects you've completed. Tailor your resume for each application to align with the job description.\n"
        )
        return random.choice(responses)
    ...
    def what_are_you(self):
        ...
        responses = (
            "I am Angel Joshi's Chatbot, designed to assist you with questions related to Hunar Intern and career development.\n",
    ...
    def who_made_you(self):
        ...
        return "I was created by Angel Joshi, a second-year engineering student at Sandip University in Nashik.\n"

    def who_is_creator(self):
        # Response to the question about the creator
        return "My creator is Angel Joshi, who designed me to assist you in your career journey.\n"
    ...
    def no_match_intent(self):
        ...
        return random.choice(responses)  # Return a random unrecognized input response
